package android.thea.widgets.tablayout;
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabStrip.setTabIndicatorPosition(typedArray.getInt(
                R.styleable.TabLayout_tabIndicatorPosition, 0));
        mTabStrip.setSelectedIndicatorHeight(
                typedArray.getDimensionPixelSize(R.styleable.TabLayout_bTabIndicatorHeight, 0));
        ...
        mTabPaddingTop = typedArray.getDimensionPixelSize(
                R.styleable.TabLayout_bTabPaddingTop, mTabPaddingTop);
        mTabPaddingEnd = typedArray.getDimensionPixelSize(
                R.styleable.TabLayout_bTabPaddingEnd, mTabPaddingEnd);
        mTabPaddingBottom = typedArray.getDimensionPixelSize(
                R.styleable.TabLayout_bTabPaddingBottom, mTabPaddingBottom);

        mTabTextAppearance = typedArray.getResourceId(R.styleable.TabLayout_bTabTextAppearance,
        ...
        if (typedArray.hasValue(R.styleable.TabLayout_bTabTextColor))
            mTabTextColors = typedArray.getColorStateList(R.styleable.TabLayout_bTabTextColor);

        if (typedArray.hasValue(R.styleable.TabLayout_bTabSelectedTextColor)) {
            final int selected = typedArray.getColor(
                    R.styleable.TabLayout_bTabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = typedArray.getDimensionPixelSize(
                R.styleable.TabLayout_bTabMinWidth, INVALID_WIDTH);
        mRequestedTabMaxWidth = typedArray.getDimensionPixelSize(
                R.styleable.TabLayout_bTabMaxWidth, INVALID_WIDTH);

        mTabBackgroundResId = typedArray.getResourceId(
                R.styleable.TabLayout_bTabBackground, 0);
        mContentInsetStart = typedArray.getDimensionPixelSize(
                R.styleable.TabLayout_bTabContentStart, 0);
        mMode = typedArray.getInt(R.styleable.TabLayout_bTabMode, MODE_FIXED);
        mTabGravity = typedArray.getInt(R.styleable.TabLayout_bTabGravity, GRAVITY_FILL);
